...
export default class PlayingScene extends Phaser.Scene {
  ...
  create() {
    ...
    // background
    this.m_background = this.add.tileSprite(0, 0, Config.width, Config.height, "background"); // 이미지를 어디까지 보여줄 것인지. map 크기만큼 채워줄 것이다.
    this.m_background.setOrigin(0, 0); // map의 어디서부터 시작할건지
